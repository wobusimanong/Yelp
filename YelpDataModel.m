...
//  YelpStudy
//
//  Created by zhuo ru li on 7/2/17.
...
- (id)initWithDictionary:(NSDictionary *)dictionary
{
    ...
    if (self) {
        ...
        NSObject *latitude = [dictionary valueForKeyPath:@"coordinates.latitude"];
        NSObject *longitude = [dictionary valueForKeyPath:@"coordinates.longitude"];
        self.latitude = [latitude isKindOfClass:[NSNumber class]] ? [[dictionary valueForKeyPath:@"coordinates.latitude"]doubleValue] : 0.0;
        self.longitude = [longitude isKindOfClass:[NSNumber class]] ? [[dictionary valueForKeyPath:@"coordinates.longitude"]doubleValue] : 0.0;
